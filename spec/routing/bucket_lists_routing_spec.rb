...
RSpec.describe Api::V1::BucketListsController, type: :routing do
  it do
    expect(get: "/api/v1/bucketlists").to route_to(
      "api/v1/bucket_lists#index", format: :json
    )
  end
  it do
    expect(post: "/api/v1/bucketlists").to route_to(
      "api/v1/bucket_lists#create", format: :json
    )
  end
  it do
    expect(get: "/api/v1/bucketlists/1").to route_to(
      "api/v1/bucket_lists#show", id: "1", format: :json
    )
  end
  it do
    expect(patch: "/api/v1/bucketlists/1").to route_to(
      "api/v1/bucket_lists#update", id: "1", format: :json
    )
  end
  it do
  ...
  it do
    expect(delete: "/api/v1/bucketlists/1").to route_to(
      "api/v1/bucket_lists#destroy", id: "1", format: :json
    )
  end
end
